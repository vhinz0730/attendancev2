                                ...
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-4">
                                        <div x-data="{ hover: false }" wire:ignore>
                                            <button x-on:mouseover="hover = true" x-on:mouseout="hover = false" type="button" wire:click="delete({{ $student->id }})" wire:confirm="Remove student?"
                                                class="btn min-w-[5rem] min-h-[2rem] bg-blue-600 font-medium text-black hover:bg-red-700 active:bg-primary-focus/90 rounded-full">
